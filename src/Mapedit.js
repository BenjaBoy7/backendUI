    ...
    if (this.state.lat !== undefined) {
      map = (
        <div>
         {/* my field here */}
          <AsyncMap
           googleMapURL={this.state.tt==1?"https://maps.googleapis.com/maps/api/js?key=AIzaSyCq6FzlBsSuT-S2zaRh2Rd-i4205DCu57s&region=AE&language=en&libraries=places":"https://maps.googleapis.com/maps/api/js?key=AIzaSyCq6FzlBsSuT-ffS2zaRh2Rd-i4205DCu57s&region=AE&language=en&libraries=places"}
