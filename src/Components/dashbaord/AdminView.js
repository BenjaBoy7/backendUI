...
const renderCustomizedLabel = ({
 ...
 class AdminView extends Component {
  ...
  <div className="mb-sm-4 d-flex flex-wrap align-items-center text-head">
    <h2 className="mb-3 ">{lang=="en"?"Dashboard":"الرئيسية"}</h2>
  {/* me-auto */}
  </div>	
  <div className="row">
	<div class="col-xl-4 col-sm-6">
						<div class="card align-items-center">
							<div class="card-body d-flex align-items-center justify-content-between">
								<div class="card-data me-2 text-center">
									<h5> {lang=="en"?"Propeties for Sale":"عقارات للبيع"}</h5>
									<h2 class="fs-40 font-w600">{this.state.sales}</h2>
								</div>
      ...
      <div className="card align-items-center">
        <div className="card-body d-flex align-items-center justify-content-between">
          <div className="card-data me-2 text-center">
            <h5>{lang=="en"?"Propeties for Rent":"عقارات للايجار"}</h5>
      ...
      <div className="card align-items-center" >
        <div className="card-body d-flex align-items-center justify-content-between ">
          <div className="card-data text-center">
            <h5> {lang=="en"?"Total Agencies":"عدد الشركات"}</h5>
    ...
    {/* <div className="col-xl-3 col-sm-6">
      <div className="card align-items-center ">
        <div className="card-body d-flex align-items-center text-center">
          <div className="card-data me-2 text-center">
            <h5> {lang=="en"?"Total City ":"عدد المدن"}</h5>
  ...
  <div className="row">
    <div className="col-xl-12col-xxl-12">
      <div className="row">
          ...
          <div className="card">
            <div className="card-header d-block border-0">
              <div className="d-flex align-items-center justify-content-between mb-3">
                <h4 className="fs-20">{lang=="en"?"Properties By Emirates":"العقارات بالمدن"}</h4>
        ...
        <div className="col-xl-6 col-xxl-12">
          <div className="card">
            <div className="card-header border-0">
              <h4 className="fs-20"> {lang=="en"?"Agencies By Emirate":"الشركات بالمدن"}</h4>
            </div>
        ...
        <div className="col-xl-12">
          <div className="card" id="responsive-map">
            <div className="card-header border-0">
              <h4 className="fs-20"> {lang=="en"?"Propeties By Months":" العقارات بالايام"}</h4>
              <div className="dropdown custom-dropdown mb-0">
                ...
                <div className="dropdown-menu dropdown-menu-right">
                  <a className="dropdown-item" href="#;"> {lang=="en"?"By Year":" العقارات بالسنين"}</a>
                  <a className="dropdown-item" href="#;">{lang=="en"?"By Month":" العقارات بالشهور"}</a>
                  <a className="dropdown-item " href="#;">{lang=="en"?" By Day ":" العقارات بالايام"}</a>
                </div>
              </div>
            </div>
