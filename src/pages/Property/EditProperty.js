...
fetchData = () => {
        ...
        .then(response => {
           // console.log("ku",response.data)
            
        this.setState({ isLoading: false,selectedAgent:response.data.property.agent_id,agent:response.data.agent,
...
saveData = (e) =>{
    ...
    axios.put(baseurl+"/api/properties/"+id, data  ,  {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Accept':'application/json',
          'Content-Type':'application/json'
  ...
  <form action method="post" role="form">
    ...
    <h5>{lang == "en" ? "Property Information" : "معلومات العقار"}</h5>
      ...
      <div className={this.state.bathroomfeature}>
                                  <div className="form-group">
                                  <label> {lang=="en"?"Bath room":"حمامات"}</label>
                                  ...
                                  <div className="form-group">
                                  <label> {lang=="en"?"Bed room":"غرف "}</label>
                              ...
                              <div className={this.state.rentfileds}>
                                  ...
                                  <div className="col-lg-6 mb-2">
                                      <div className="mb-3">
                                          <input type="number" defaultValue={this.state.property.min_contract_period} className="form-control" placeholder={i18next.t("mincontract")} onChange={this.handleMinimumcontractperiod} id="mincontract" />
                                      </div>
                                  </div>
                                  <div className="col-lg-6 mb-2">
                                      <div className="mb-2">
                                  ...
                                  <div className="col-lg-6 mb-2">
                                      <div className="mb-3">
                                          <input type="number" defaultValue={this.state.property.maintainance_fee} className="form-control" placeholder={i18next.t("mantianancefee")} onChange={this.handleMaintainaceFee} id="mantianancefee" />
                                      </div>
                                  </div>
                                  <div className="col-lg-6 mb-2">
                                      <div className="mb-3">
                           ...
                           <div className="">
                           {role == 2?<div class="mb-3 col-md-12">
                                            <select onChange={this.handleAgent} class="form-select select2-container--default" style={{ height: '2.75rem' }} aria-label="form-select" >
                                            <option selected value={this.state.property.agent_id}>{lang=="en"?this.state.property.agent_name_en:this.state.property.agent_name_ar}</option>
                                            {this.state.agents.map((agent) => (
                                                <>
                                             { agent.id !=this.state.property.agent_id?   <option value={agent.id}>{lang=="en"?agent.name_en:agent.name_ar}</option>:null}
