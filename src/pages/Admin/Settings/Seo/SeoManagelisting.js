...
class SeoManagelisting extends Component {
    constructor(props)
    {
        super(props);
        this.state = {
                                                    ...
                                                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        ...
                                                        <td>
                                                            <div className="ms-auto">
                                                                ...
                                                                <Link to={"seoeditlist/"+managelisting.id} className="btn btn-primary btn-sm m-2"><i className="bi bi-pencil-square"></i></Link>
...
export default SeoManagelisting;