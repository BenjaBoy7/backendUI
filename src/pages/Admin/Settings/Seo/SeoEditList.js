...
class SeoEditList extends Component {
...
//  }
 ...
 handleSeoTitleEn= (e) =>{
    e.preventDefault() 
   this.setState({seo_title_en:e.target.value})
}
handleSeoTitleAr= (e) =>{
   this.setState({seo_title_ar:e.target.value})
}
...
fetchData = () => {
        ...
        price:response.data.property.price,square_area:response.data.property.area,
        ...
        propertytype_id:response.data.property.propertytypes_id,
  ...
  this.mapfunction()
      ...
      .catch(err =>console.log("error"))
        ...
        axios.get(baseurl+"/api/propertyseo/"+id,{
            headers: {
              'Authorization': `Bearer ${token}`,
              'Accept':'application/json',
              'Content-Type':'application/json'
        ...
        this.setState({seo_title_en:response.data.seo_title_en,seo_title_ar:response.data.seo_title_ar, seo_description_en: response.data.seo_description_en, seo_description_ar: response.data.seo_description_ar})
...
saveData = (e) =>{
        ...
        seo_title_en:this.state.seo_title_en, seo_title_ar:this.state.seo_title_ar,
        seo_description_en:this.state.seo_description_en, seo_description_ar:this.state.seo_description_ar,
    }
    axios.put(baseurl+"/api/seoproperties/"+id, data  ,  {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Accept':'application/json',
          'Content-Type':'application/json'
    ...
    .then(response =>{
        ...
        Swal.fire({
            ...
            this.props.history.push("/seolisting")
    })
...
<div className="form-wizard">
  <form action method="post" role="form">
    ...
    <fieldset className="wizard-fieldset">
      <h5>{lang == "en" ? "SEO DETAILS" : "SEO DETAILS"}</h5>
  
                                      <div  className="tab-pane" role="tabpanel">
                                      <div className="form-group">
                      <input type="text" defaultValue={this.state.seo_title_en} className="form-control wizard-required" id="seo_title_en" placeholder={i18next.t("title_en")} onChange={this.handleSeoTitleEn}  />
                      </div>
                      <div className="form-group">
                      <input type="text" defaultValue={this.state.seo_title_ar} className="form-control wizard-required" id="seo_title_ar" placeholder={i18next.t("title_ar")} onChange={this.handleSeoTitleAr}  />
                      </div>
                      <div className="form-group">
                      <JoditEditor
                                                //ref={editor}
                                                value={this.state.seo_description_en}
                                                config={config}
                                                tabIndex={1} // tabIndex of textarea
                                                onBlur={newContent => this.setState({seo_description_en:newContent})} // preferred to use only this option to update the content for performance reasons
                                                onChange={newContent => {}}
                                               />
                      </div>
                      <div className="form-group">
                      <JoditEditor
                                                //ref={editor}
                                                value={this.state.seo_description_ar}
                                                config={config}
                                                tabIndex={1} // tabIndex of textarea
                                                onBlur={newContent => this.setState({seo_description_ar:newContent})} // preferred to use only this option to update the content for performance reasons
                                                onChange={newContent => {}}
                                               />
                          </div>
                                    </div>
