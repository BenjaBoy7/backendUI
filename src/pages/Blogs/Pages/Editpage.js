 ...
 class Editpage extends Component {
     ...
     componentDidMount() {
        ...
        axios.get(baseurl+"/api/page/" + id,{
            ...
            .then(response => {
                ...
                this.setState({
                    purpose:response.data.page.purpose,propertytype:response.data.page.propertytype,propertytypeName_en:response.data.page.typeName_en,propertytypeName_ar:response.data.page.typeName_ar,
                    price_from:response.data.page.price_from,price_to:response.data.page.price_to,usedImage:response.data.page.image,usedImage_ar:response.data.page.image_ar,
                    bath_room:response.data.page.bath_room,bed_room:response.data.page.bed_room,rent_frequence:response.data.page.rent_frequence,
                    description_en:response.data.page.description_en,description_ar:response.data.page.description_ar,
                    alttext_en:response.data.page.alt_text,alttext_ar:response.data.page.alt_text_ar,
                    focuskeyphrases_en:response.data.page.keyphrases_en, focuskeyphrases_ar:response.data.page.keyphrases_ar,
                    seotitle_en:response.data.page.seotitle_en,seotitle_ar:response.data.page.seotitle_ar,
                    metadescription_en:response.data.page.meta_en,metadescription_ar:response.data.page.meta_ar,
                    selectedfeature: lang=="en"? response.data.pagefeatures_en:response.data.pagefeatures_ar
  ...
  createImage_ar(file) {
    ...
    handleSaveData = (e) =>{
     ...
     axios.put(baseurl+"/api/page/"+id, data  ,  {
      headers: {
        'Authorization': `Bearer ${token}`,
        'Accept':'application/json',
        'Content-Type':'application/json'
            ...
            <div className="container-fluid">
                ...
                <div className="col-sm-3">
                    ...
                    <select  className="form-select wizard-required" style={{ height: '2.75rem' }} aria-label="form-select" onChange={this.handlePropertytype}>
                      <option selected value={this.state.propertytype} >{lang=="en"? this.state.propertytypeName_en:this.state.propertytypeName_ar}</option>
                      {this.state.propertytypes.map((propertytype) =>(
                        <>
                        {propertytype.id != this.state.propertytype?<option value={propertytype.id}>{lang == "en"? propertytype.typeName_en:propertytype.typeName_ar}</option>:null}
                ...
                <div className="row mt-3">
                    ...
                    <input type="number" className="form-control" value={this.state.price_from}    onChange={this.handlePrice_from} />   

                    </div>
                    <div className="col-sm-2">
                
                    <input type="number" className="form-control" value={this.state.price_to}    onChange={this.handlePrice_to} />   
                    ...
                    <option value={this.state.bath_room}>{this.state.bath_room}</option>
                    ...
                    <option value={this.state.bed_room}>{this.state.bed_room == 0? "Studio":this.state.bed_room}</option>
                ...
                <div className="tab-content" id="myTabContent">
                  <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                      <div className="row mt-5">
                                            <div className="col-md-4">
                                                <label><i class="bi bi-camera"></i>&nbsp;&nbsp; Add Media  </label>
                                                ...
                                                {this.state.image!=null? <img src={this.state.imageShow} style={{width:'700px',height:'350px'}}/>:(   <div>  {this.state.usedImage !=null? 
                                                <img src={baseurl+"/public/uploads/pages/"+this.state.usedImage} style={{width:'700px',height:'350px'}}/>:
                                                null
                                            }
                                            </div>
                                            )}
                                                ...
                                                <input type="text" onChange={this.handleAlttext_en} className=" form-control" value={this.state.alttext_en}  />   
                                                </div>
                                            </div>
                                            <div className="row">
                                      ...
                                      <div className="col-md-8">
                                        <div className="tab-content" id="nav-tabContent">
                                          <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                           ...
                                           <input type="text" className="form-control m-2" onChange={this.handleFocuskeyphrases_en} value={this.state.focuskeyphrases_en}/> 
                                           <label>SEO Title</label>
                                           <input type="text" className=" form-control m-2" onChange={this.handleSeotitle_en} value={this.state.seotitle_en} /> 
                                           <label>Meta description</label>
                                           <textarea type="text" className=" form-control m-2" rows={3} onChange={this.handleMetadescription_en} value={this.state.metadescription_en} /> 
                  ...
                  <div className="row mt-5" dir="rtl">
                                            <div className="col-md-4">
                                                ...
                                                <div className="mt-10" style={{margin:'20px'}}>                                       
                                                {this.state.image_ar!=null? <img src={this.state.imageShow_ar} style={{width:'700px',height:'350px'}}/>:(   <div>  {this.state.usedImage_ar !=null? 
                                                <img src={baseurl+"/public/uploads/pages/"+this.state.usedImage_ar} style={{width:'700px',height:'350px'}}/>:
                                                null
                                            }
                                            </div>
                                            )}
                                                ...
                                                <div className="col-md-8">
                                                    <label>Alt Text</label>
                                                <input type="text" onChange={this.handleAlttext_ar} className=" form-control" value={this.state.alttext_ar} />   
                                                </div>
                                            </div>
                                      ...
                                      <div className="col-md-8">
                                        <div className="tab-content" id="nav-tabContent">
                                          <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                           <div className="mt-5">
                                           <label>Focus keyphrases</label>
                                           <input type="text" className="form-control m-2" onChange={this.handleFocuskeyphrases_ar} value={this.state.focuskeyphrases_ar} /> 
                                           <label>SEO Title</label>
                                           <input type="text" className=" form-control m-2" onChange={this.handleSeotitle_ar} value={this.state.seotitle_ar}/> 
                                           <label>Meta description</label>
                                           <textarea type="text" className=" form-control m-2" rows={3} onChange={this.handleMetadescription_ar} value={this.state.metadescription_ar} /> 
                  ...
                  <div className="mb-3">
                     <button type="submit" className="btn btn-primary me-3 mb-3"  onClick={this.handleSaveData}> <i className="bi bi-plus"></i>  Update Page</button>
                </div>
                </div>
                </div>
