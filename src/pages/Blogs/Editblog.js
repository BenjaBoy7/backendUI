 ...
 class Editblog extends Component {
            ...
            axios.get(baseurl+"/api/blog/" + id,{
                ...
                .then(response => {
                    ...
                    for (i=0; i < data.length; i++) {   
                        if(data[i].lang==1){  tagsArray_en.push(data[i]);}
                        else
                        if(data[i].lang==2){
                            tagsArray_ar.push(data[i]);
                        }
                     
                    }

                    this.setState({
                          category_id:response.data.blog.blogcategory_id,title_en:response.data.blog.title_en,title_ar:response.data.blog.title_ar,
                          description_en:response.data.blog.description_en,description_ar:response.data.blog.description_ar,
                          alttext_en:response.data.blog.alttext_en,alttext_ar:response.data.blog.alttext_ar,
                          usedImage:response.data.blog.image,usedImage_ar:response.data.blog.image_ar,
                          focuskeyphrases_en:response.data.blog.focuskeyphrases_en, focuskeyphrases_ar:response.data.blog.focuskeyphrases_ar,
                          seotitle_en:response.data.blog.seotitle_en,seotitle_ar:response.data.blog.seotitle_ar,
                          slug_en:response.data.blog.slug_en, slug_ar:response.data.blog.slug_ar,
                          metadescription_en:response.data.blog.metadescription_en,metadescription_ar:response.data.blog.metadescription_ar,
                          tags:tagsArray_en,tags_ar:tagsArray_ar
    ...
    createImage_ar(file) {
      ...
      handleAddTag_ar = (e) =>{
          ...
          return
          const data = {tag:this.state.tag_ar}
    ...
    handleSaveData = (e) =>{
        ...
        const token = cookie.get("token")
        axios.put(baseurl+"/api/blog/" + id ,data  ,  {
            headers: {
              'Authorization': `Bearer ${token}`,
              'Accept':'application/json',
              'Content-Type':'application/json'
                                    ...
                                    <div className="basic-form">
                                        ...
                                        <ul className="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <div className="col-md-12">
                                                   ...
                                                   <div className="mb-3">
                                                   <label>Title</label>
                                                   <input type="text" value={this.state.title_en} onChange={this.handleTitle_en}  className="form-control input-rounded" placeholder="Title" />
                                               </div>
                                            </div>
                                            <div className="row">
                                            <div className="col-md-4">
                                                ...
                                                <img src={baseurl+"/public/uploads/blogs/"+this.state.usedImage} style={{width:'700px',height:'350px'}}/>:
                                                null
                                            }
                                            </div>
                                            )}
                                                ...
                                                <input type="text" value={this.state.alttext_en} onChange={this.handleAlttext_en} className=" form-control"  />   
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="col-md-12">
                                               ...
                                               />
                                                ...
                                                <div className="col-md-8">
                                                    ...
                                                    <input type="text" value={this.state.focuskeyphrases_en} className="form-control m-2" onChange={this.handleFocuskeyphrases_en} /> 

                                                    <label>SEO Title</label>
                                                    <input type="text" value={this.state.seotitle_en} className=" form-control m-2" onChange={this.handleSeotitle_en} /> 

                                                    <label>Slug</label>
                                                    <input type="text" value={this.state.slug_en} className=" form-control m-2"  onChange={this.handleSlug_en} /> 

                                                    <label>Meta description</label>
                                                    <textarea type="text" value={this.state.metadescription_en} className=" form-control m-2" rows={3} onChange={this.handleMetadescription_en} /> 
                                                   </div>
                                                    </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="col-md-12">
                                                   ...
                                                   <div className="mb-3">
                                                   <label>العنوان</label>
                                                   <input type="text" value={this.state.title_ar} onChange={this.handleTitle_ar}  className="form-control input-rounded" placeholder="Title" />
                                               </div>
                                            </div>
                                            <div className="row">
                                            <div className="col-md-4">
                                                ...
                                                <img src={baseurl+"/public/uploads/blogs/"+this.state.usedImage_ar} style={{width:'700px',height:'350px'}}/>:
                                                null
                                            }
                                            </div>
                                            )}
                                                ...
                                                <div className="col-md-8">
                                                    <label>Alt Text</label>
                                                <input type="text" value={this.state.alttext_ar} onChange={this.handleAlttext_ar} className=" form-control"  />   
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="col-md-12">
                                               ...
                                               />
                                                ...
                                                <div className="col-md-8">
                                                    ...
                                                    <div className="mt-5">
                                                    <label>Focus keyphrases</label>
                                                    <input type="text" value={this.state.focuskeyphrases_ar} className="form-control m-2" onChange={this.handleFocuskeyphrases_ar} /> 

                                                    <label>SEO Title</label>
                                                    <input type="text" value={this.state.seotitle_ar} className=" form-control m-2" onChange={this.handleSeotitle_ar} /> 

                                                    <label>Slug</label>
                                                    <input type="text" value={this.state.slug_ar} className=" form-control m-2"  onChange={this.handleSlug_ar} /> 

                                                    <label>Meta description</label>
                                                    <textarea type="text" value={this.state.metadescription_ar} className=" form-control m-2" rows={3} onChange={this.handleMetadescription_ar} /> 
                                            ...
                                            <div className="mb-3">
                                            <button type="submit" className="btn btn-primary me-3 mb-3"  onClick={this.handleSaveData}> <i className="bi bi-edit"></i>  Update Blog</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
