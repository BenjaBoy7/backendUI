...
class Managelisting extends Component {
    ...
    fetchData = () => {
        ...
        axios.get(baseurl + "/api/managelisting",{
            headers: {
                                                    ...
                                                    {managelisting.status_id ==5? (<span className="badge light  badge-danger">{lang == "en" ? managelisting.status_en : managelisting.status_ar}</span>):null}                                                                                                        
                                                        ...
                                                        <td>
                                                            <div className="ms-auto">
                                                                ...
                                                                <a href="#" className="m-2" onClick={this.handelBasic.bind(this, managelisting)} title={managelisting.package_type == 1?"":"Click to make it basic"}>
                                                                    {managelisting.basicbutton ==true?<img src="./4.png" />:<img src="./1.png" />}
                                                                    </a>

                                                                    {managelisting.featuredbutton ==true?
                                                                      <a href="#" className="m-2" onClick={this.handelBasic.bind(this, managelisting)} title={managelisting.package_type == 2?"":"Click to make it basic"}>
                                                                    <img src="./5.png" />
                                                                    </a>
                                                                    :
                                                                    <a href="#" className="m-2" onClick={this.handelFeature.bind(this, managelisting)} title={managelisting.package_type != 2?"":"Click to make it feature"}>
                                                                    <img src="./2.png" />
                                                                    </a>
                                                                    }
                                                                   
                                                                    {managelisting.premiumbutton ==true?
                                                                    <a href="#" className="m-2" onClick={this.handelBasic.bind(this, managelisting)} title={managelisting.package_type == 3?"":"Click to make it basic"}>

                                                                    <img src="./6.png" />
                                                                    </a>
                                                                    :
                                                                    <a href="#" className="m-2" onClick={this.handelPremium.bind(this, managelisting)} title={managelisting.package_type != 3?"":"Click to make it premium"}>
                                                        ...
                                                        <td>
                                                            <div className="ms-auto">
                                                                <Link to={"showProperty/"+managelisting.id} className="btn btn-success btn-sm m-2" title="Refresh Property">
                                                                <img src="./refresh.png" style={{height:'20px',width:'20px'}} />
                                                                </Link>
                                                                <Link to={"editProperty/"+managelisting.id} className="btn btn-primary btn-sm m-2"><i className="bi bi-pencil-square"></i></Link>
